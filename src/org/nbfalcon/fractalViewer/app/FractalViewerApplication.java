...
public class FractalViewerApplication implements FractalViewerApplicationContext {
    ...
    public void createInitialWindow() {
        FractalViewerWindow window = new FractalViewerWindow(new AsyncImageViewer(new MandelbrotFractal()), this);
        registerWindow(window, true);
    }

    // FIXME: we probably want logging here
    public boolean waitForShutdown() throws InterruptedException {
        ...
        return myRenderPool.getExecutorService().awaitTermination(30, TimeUnit.SECONDS);
    }
