...
public abstract class FractalBase implements FractalRenderer {
    ...
    protected SimplePromise<BufferedImage> renderWithCustomPool1(MultithreadedExecutor pool, ViewPort viewPort, int width, int height, final FractalPixelCalc how) {
